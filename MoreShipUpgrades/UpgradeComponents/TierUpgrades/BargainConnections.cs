...
namespace MoreShipUpgrades.UpgradeComponents.TierUpgrades
{
    class BargainConnections : TierUpgrade
    {
        ...
        public static int GetBargainConnectionsAdditionalItems(int defaultAmountItems)
        {
            ...
            return defaultAmountItems + UpgradeBus.instance.cfg.BARGAIN_CONNECTIONS_INITIAL_ITEM_AMOUNT + (UpgradeBus.instance.bargainConnectionsLevel * UpgradeBus.instance.cfg.BARGAIN_CONNECTIONS_INCREMENTAL_ITEM_AMOUNT);
        }
        public override string GetDisplayInfo(int initialPrice = -1, int maxLevels = -1, int[] incrementalPrices = null)
        {
            System.Func<int, float> infoFunction = level => UpgradeBus.instance.cfg.BARGAIN_CONNECTIONS_INITIAL_ITEM_AMOUNT + (level * UpgradeBus.instance.cfg.BARGAIN_CONNECTIONS_INCREMENTAL_ITEM_AMOUNT);
