    ...
    public class ClayGlasses : TierUpgrade
    {
        ...
        public override bool CanInitializeOnStart
        {
            get
            {
                ...
                return UpgradeBus.Instance.PluginConfiguration.CLAY_GLASSES_PRICE.Value <= 0 && prices.Length == 1 && (prices[0].Length == 0 || prices[0] == "0");
            }
        }
        ...
        {
            static float infoFunction(int level) => UpgradeBus.Instance.PluginConfiguration.CLAY_GLASSES_DISTANCE_INITIAL_INCREASE.Value + (level * UpgradeBus.Instance.PluginConfiguration.CLAY_GLASSES_DISTANCE_INCREMENTAL_INCREASE.Value);
