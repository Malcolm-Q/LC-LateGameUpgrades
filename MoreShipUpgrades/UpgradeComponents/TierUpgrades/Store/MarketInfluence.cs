...
namespace MoreShipUpgrades.UpgradeComponents.TierUpgrades.Store
{
    internal class MarketInfluence : TierUpgrade
    {
        ...
        {
            static float infoFunction(int level) => UpgradeBus.Instance.PluginConfiguration.MARKET_INFLUENCE_INITIAL_PERCENTAGE.Value + (level * UpgradeBus.Instance.PluginConfiguration.MARKET_INFLUENCE_INCREMENTAL_PERCENTAGE.Value);
        ...
        public override bool CanInitializeOnStart
        {
            get
            {
                ...
                return UpgradeBus.Instance.PluginConfiguration.MARKET_INFLUENCE_PRICE.Value <= 0 && prices.Length == 1 && (prices[0].Length == 0 || prices[0] == "0");
            }
        }
