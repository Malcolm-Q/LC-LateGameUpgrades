...
namespace MoreShipUpgrades.UpgradeComponents.TierUpgrades.Player
{
    internal class DeepPockets : TierUpgrade
    {
        ...
        {
            static float infoFunction(int level) => UpgradeBus.Instance.PluginConfiguration.DEEPER_POCKETS_INITIAL_TWO_HANDED_ITEMS.Value + (level * UpgradeBus.Instance.PluginConfiguration.DEEPER_POCKETS_INCREMENTAL_TWO_HANDED_ITEMS.Value);
        ...
        public override bool CanInitializeOnStart
        {
            get
            {
                ...
                return UpgradeBus.Instance.PluginConfiguration.DEEPER_POCKETS_PRICE.Value <= 0 && prices.Length == 1 && (prices[0].Length == 0 || prices[0] == "0");
            }
        }
