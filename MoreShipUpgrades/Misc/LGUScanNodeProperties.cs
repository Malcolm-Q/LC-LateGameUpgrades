...
namespace MoreShipUpgrades.Misc
{
    ...
    internal static class LguScanNodeProperties
    {
        ...
        public static void ChangeScanNode(ref ScanNodeProperties scanNodeProperties, NodeType nodeType, string header = "LGU Scan Node", string subText = "Used for LGU stuff", int creatureScanID = -1, int scrapValue = 0, int minRange = 2, int maxRange = 7, bool requiresLineOfSight = true)
        {
        ...
        static void AddScanNode(GameObject objectToAddScanNode, NodeType nodeType, string header = "LGU Scan Node", string subText = "Used for LGU stuff", int creatureScanID = -1, int minRange = 2, int maxRange = 7, bool requiresLineOfSight = true)
        {
            ...
            ChangeScanNode(scanNodeProperties: ref scanNodeProperties, nodeType: nodeType, header: header, subText: subText, creatureScanID: creatureScanID, minRange: minRange, maxRange: maxRange, requiresLineOfSight: requiresLineOfSight);
        }
        /// <summary>
        ...
        /// <param name="minRange">Minimum range required to display this node</param>
        /// <param name="maxRange">Maximum range allowed to display this node</param>
        public static void AddGeneralScanNode(GameObject objectToAddScanNode, string header = "LGU Scan Node", string subText = "Used for LGU stuff", int creatureScanID = -1, int minRange = 2, int maxRange = 7, bool requiresLineOfSight = true)
        {
            AddScanNode(objectToAddScanNode: objectToAddScanNode, nodeType: NodeType.GENERAL, header: header, subText: subText, creatureScanID: creatureScanID, minRange: minRange, maxRange: maxRange, requiresLineOfSight: requiresLineOfSight);
        }
        /// <summary>
