...
namespace MoreShipUpgrades.Misc.Util
{
    internal static class Tools
    {
        ...
        {
            if (UpgradeBus.Instance.IsBeta) Landmine.SpawnExplosion(explosionPosition, spawnExplosionEffect, killRange, damageRange, nonLethalDamage, physicsForce, overridePrefab);
            else SpawnExplosion(explosionPosition, spawnExplosionEffect, killRange, damageRange);
        }
        /// <summary>
        /// Bandaid for v49 compatibility 
        /// </summary>
        /// <param name="explosionPosition"></param>
        /// <param name="spawnExplosionEffect"></param>
